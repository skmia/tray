...
#Mozilla/5.0 (Linux; Android 13; Redmi Noot pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)        
        print(" [A] RANDOM  NUMBER CLONE \033[1;34m")
        print(" [B] MY fACEBOOK ACCOUNT  \033[1;35m")
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://www.facebook.com/hafejmdshoriful.shorif?mibextid=ZbWKwL/')
        if Alif in ["1", "01"]:
